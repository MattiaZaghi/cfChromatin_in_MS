...
REFERENCE_DATA = {
    ...
    "Megakaryocyte":  {"url": "TODO_BLUEPRINT_Megakaryocyte_H3K27ac_peaks.bed.gz",
                       "tags": ["other"]},
    # ── ENCODE GRCh37 (CNS) ───────────────────────────────────────────────
    "Oligodendrocyte":{"url": "/date/gcb/gcb_MZ/Brain_ChIP/Olig2_optimal_peak.H3K27.bed.gz",
                       "tags": ["cns"]},
    "OPC":            {"url": "TODO_ENCODE_OPC_H3K27ac_hg19.bed.gz",
                       "tags": ["cns"]},
    "Neuron":         {"url": "/date/gcb/gcb_MZ/Brain_ChIP/NeuN_optimal_peak.H3K27.bed.gz",
                       "tags": ["cns"]},
    "Astrocyte":      {"url": "/date/gcb/gcb_MZ/Brain_ChIP/LHX2_optimal_peak.H3K27.bed.gz",
                       "tags": ["cns"]},
    "Microglia":      {"url": "/date/gcb/gcb_MZ/Brain_ChIP/PU1_optimal_peak.H3K27.bed.gz",
                       "tags": ["cns"]},
}
# ─────────────────────────────────────────────────────────────────────────────
