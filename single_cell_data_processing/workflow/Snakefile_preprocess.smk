...
ruleorder: run_cellranger_ATAC >  bam_to_bw > run_macs_broad > barcode_metrics_peaks > barcode_metrics_all > cell_selection 
...
rule run_cellranger_ATAC:
    ...
    shell:
        ...
        '{params.cellranger_software} count --id cellranger --reference {params.cellranger_ref}  --fastqs {params.fastq_folder} --localcores={threads}  --localmem={resources.mem_gb}'
